...
for instance_id in {1..10}; do		
	...
	./tri-match -t smat -H $H_net -G $G_net -S $SeqSim -Y 0 -a 0.15 -b 0.1 --iter 3 -x seqsim -o Family$i_output &
	./tri-match -t smat -H $H_net -G $G_net -S $SeqSim -Y 0 -a 0.5 -b 0.1 --iter 3 -x seqsim  -o Family$i_output &
	./tri-match -t smat -H $H_net -G $G_net -S $SeqSim -Y 0 -a 0.85 -b 0.1 --iter 3 -x seqsim -o Family$i_output &
